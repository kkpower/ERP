    ...
    <div class="col-md-12">
        <section class="panel">
            <header class="panel-heading">
                ...
                <h2 class="panel-title"><?php echo (L("total_inventory_inquiry")); ?></h2>
            </header>
            <div class="panel-body">
                <form class="" action="<?php echo U('Warehouse/inventoryTotal','','');?>" method="get" style="margin-right:15px;">
                    <div class="col-md-7" style="padding-left: 0;">
                        <div class="input-group">
                            <span class="input-group-addon"><?php echo (L("product")); ?></span>
                ...
                <div style="float: right;"><?php echo (L("Total")); ?>:<span style="font-size: 16px;color: red;"> <?php echo ($total); ?></span> RMB</div>
            </div>
        </section>
    </div>
</div>
