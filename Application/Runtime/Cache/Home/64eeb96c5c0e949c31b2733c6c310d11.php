	...
	<div class="col-md-12">
		<section class="panel">
			...
			<div class="panel-body">
				...
				<form class="" action="<?php echo U('PurchaseOrder/historicalOrder');?>" method="get" style="margin-right:15px ;">
					...
					<div id="status_div" class="col-md-5">
						<div class="input-group">
							...
							<select name="supplier_id" id="supplier" class="form-control" data-live-search="true">
								<option value="">--全部--</option>
								<?php if(is_array($supplier)): $i = 0; $__LIST__ = $supplier;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pr): $mod = ($i % 2 );++$i;?><option value="<?php echo ($pr["id"]); ?>"><?php echo ($pr["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
							</select>
							<!--<select id="supplier" class="form-control" name="supplier_id">-->
								<!--<option value="">&#45;&#45;请选择&#45;&#45;</option>-->
								<!--<?php if(is_array($supplier)): foreach($supplier as $key=>$wa): ?>-->
					...
					<tbody id="tbody-resultd">
						<?php if(is_array($purchaselist)): $k = 0; $__LIST__ = $purchaselist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
								...
								<td>
									...
									<a href="<?php echo U('PurchaseOrder/completedDetails',array('id'=>$vo['id']));?>" target="_blank" style="border: 0px;color: #fff;" class="btn btn-primary btn-xs">详情</a>
								</td>
