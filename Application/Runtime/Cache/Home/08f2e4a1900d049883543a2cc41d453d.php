			...
			<div class="panel-body">
				...
				<div id="myTabContent" class="tab-content">
					<div class="tab-pane fade in active" id="home" style="height: 400px;">
						<textarea id="zh_txt" name="" rows="" cols="" style="width: 100%;height: 100%;"><?php echo ($listzh); ?></textarea>
					</div>
					<div class="tab-pane fade" id="ios" style="height: 400px;">
						<textarea id="en_txt" name="" rows="" cols="" style="width: 100%;height: 100%;"><?php echo ($listen); ?></textarea>
					</div>
				</div>
...
<script>
	$('#save').on('click', function() {
		$.ajax({
			url: "<?php echo U('Config/langSave');?>", //通过JQ获取URL获得路径
			data: {
				en: $('#en_txt').val(),
				zh: $('#zh_txt').val()
			}, //通过页面元素的ID来获取设备ID
