    ...
    <div class="col-md-12">
        <section class="panel">
            <header class="panel-heading">
                ...
                <h2 class="panel-title"><?php echo (L("in_transit")); ?></h2>
            </header>
            <div class="panel-body">
                <form class="" action="<?php echo U('Warehouse/transportationIn','','');?>" method="get" style="margin-right:15px ;">
                    ...
                    <div class="col-md-3" style="padding-left: 0;">
                        <input type="hidden" value="<?php echo ($k_id); ?>" id="ckk">
                        <div class="input-group">
                            <span class="input-group-addon"><?php echo (L("Receivingwarehouse")); ?></span>
                    ...
                    <div class="col-md-2" style="padding-left: 0;">
                        <button type="submit" class="btn btn-primary" id="seare"><?php echo (L("Search")); ?></button>
                    </div>
                </form>
                <br style="clear: both;" />
                <table id="table1" class="table table-hover mb-none table-striped table-bordered" style="border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        <th class="bm" style="cursor: pointer;"><?php echo (L("UnitPrice")); ?>(RMB)</th>
                        <th style="cursor: pointer;"><?php echo (L("Number")); ?><span class="caret"></span></th>
                        <th><?php echo (L("Amount")); ?>(RMB)</th>
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td class="bm"><a href="<?php echo U('Product/homeProduct',array('pid'=>$vo['pid']));?>" target="_blank"><?php echo ($vo["bclassc_number"]); ?>.<?php echo ($vo["sclassc_number"]); ?>.<?php echo ($vo["snumber_number"]); ?></a></td>
                            ...
                            <td></td>
                            <td><?php echo ($vo["zkname"]); ?></td>
                            <td><a href="<?php echo U('Warehouse/detailsTransportation',array('pid'=>$vo['pid'],'kid'=>$vo['zk_id']));?>" class="btn btn-primary btn-xs" style="color: #fff;"  target="_blank" ><?php echo (L("Details")); ?></a></td>
