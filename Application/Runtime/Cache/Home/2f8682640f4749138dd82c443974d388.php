            ...
            <div id="userbox" class="userbox">
                ...
                <div class="dropdown-menu">
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <a role="menuitem" tabindex="-1" href="<?php echo U('My/me');?>"><i class="fa fa-user"></i> Personal</a>
                        </li>
                        <li>
                            <a role="menuitem" tabindex="-1" href="<?php echo U('System/proving');?>"><i class="fa fa-lock"></i> Password</a>
                        </li>
                        <!--<li>
                            <a role="menuitem" tabindex="-1" href="#" data-lock-screen="true"><i class="fa fa-lock"></i> Lock Screen</a>
                        </li>-->
                        <li>
                            <a role="menuitem" tabindex="-1" href="<?php echo U('Login/loginOut','','');?>"><i class="fa fa-power-off"></i> Logout</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="col-md-12">
        <section class="panel">
            <header class="panel-heading">
                ...
                <h2 class="panel-title">采购订单号:<span style="color: #EE0000;font-weight: bold;">PO<?php echo ($purchase_successid); ?></span></h2>
            </header>
            <div class="panel-body">
                <div id="node_message" style="position: fixed;top: 50%;left: 50%;display: none;background: #888;min-width:300px;margin-left: -150px;margin-top:-15px;border-radius: 8px;text-align: center;font-size: 16px;padding: 12px 20px;color: #fff;z-index: 1200;"></div>
                <form class="" action="<?php echo U('PurchaseOrder/completedDetails',array('id'=>$gid));?>" method="get" style="display: inline-block;float: left;margin-right:15px ;">
                ...
                <table id="table" class="table table-hover mb-none table-striped table-bordered" style="border-collapse: collapse;margin-top: 15px;">
                    ...
                    <tr>
                        ...
                        <th>审核人</th>
                        <th>审核时间</th>
                        <?php if($purchaselist["status"] == 27 ): ?><th>操作</th><?php endif; ?>
                    </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td><?php echo ($purchaselist["tracking_number"]); ?></td>
                            <td><a href="<?php echo U('Supplier/detail',array('id'=>$purchaselist['supplier_id']));?>" target="_blank"><?php echo ($purchaselist["suppliername"]); ?></a></td>
                            <td><?php echo ($purchaselist["zkname"]); ?></td>
                            <td><?php echo ($purchaselist["yssname"]); ?></td>
                            <td>
                               <?php echo ($purchaselist["ysfxname"]); ?>
                            </td>
                            <td><?php echo ($purchaselist["freight"]); ?></td>
                            <input type="hidden" id="date" value="<?php echo ($purchaselist["delivery_date"]); ?>">
                            <td id="datec"></td>
                            <td><?php echo ($purchaselist["remarks"]); ?></td>
                            <td><?php echo ($purchaselist["lastnamezh"]); echo ($purchaselist["namezh"]); ?></td>
                            <td><?php echo ($purchaselist["creationtime"]); ?></td>
                            <td><?php echo ($purchaselist["lastnamezhs"]); echo ($purchaselist["namezhs"]); ?></td>
                            <td><?php echo ($purchaselist["examine_time"]); ?></td>
                        </tr>
                    </tbody>
                </table>
                <table id="table1" class="table table-hover mb-none table-striped table-bordered" style="border-collapse: collapse;">
                    ...
                    <tr>
                        <th>产品料号</th>
                        <th>产品名称</th>
                        <th>单价(<?php echo ($productlist[0]['currency']); ?>)</th>
                        <th>预期数量</th>
                        <th>收货数量</th>
                        <th>问题类型</th>
                        <th>收货时间</th>
                    ...
                    <?php if(is_array($productlist)): $k = 0; $__LIST__ = $productlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                            ...
                            <td><?php echo ($vo["actual_num"]); ?></td>
                            <td>  <?php if($vo["abnormal"] == 2 ): ?>收货收少<?php endif; if($vo["abnormal"] == 3 ): ?>收货收多<?php endif; ?></td>
                            <td><?php echo ($vo["receiving_time"]); ?></td>
                            <td>
                                <?php if($vo["abnormal"] == 2 ): ?><button id="zq" onclick='areaturn("<?php echo ($vo["id"]); ?>","<?php echo ($vo["supplier_id"]); ?>","<?php echo ($vo["supplier_pr_id"]); ?>","<?php echo ($vo["price"]); ?>","<?php echo ($vo["num"]); ?>","<?php echo ($vo["currency"]); ?>")' style="border: 0px;" type="button" class="btn btn-primary btn-xs" >
                                    继续来货
                                </button> <button id="zq" onclick='areaturn("<?php echo ($vo["id"]); ?>","<?php echo ($vo["supplier_id"]); ?>","<?php echo ($vo["supplier_pr_id"]); ?>","<?php echo ($vo["price"]); ?>","<?php echo ($vo["num"]); ?>","<?php echo ($vo["currency"]); ?>")' style="border: 0px;" type="button" class="btn btn-primary btn-xs" >
                                    终止来货
                                </button><?php endif; ?>
                                <?php if($vo["abnormal"] == 3 ): ?><button id="zq" onclick='areaturn("<?php echo ($vo["id"]); ?>","<?php echo ($vo["supplier_id"]); ?>","<?php echo ($vo["supplier_pr_id"]); ?>","<?php echo ($vo["price"]); ?>","<?php echo ($vo["num"]); ?>","<?php echo ($vo["currency"]); ?>")' style="border: 0px;" type="button" class="btn btn-primary btn-xs" >
                                    退货
                                </button> <button id="zq" onclick='areaturn("<?php echo ($vo["id"]); ?>","<?php echo ($vo["supplier_id"]); ?>","<?php echo ($vo["supplier_pr_id"]); ?>","<?php echo ($vo["price"]); ?>","<?php echo ($vo["num"]); ?>","<?php echo ($vo["currency"]); ?>")' style="border: 0px;" type="button" class="btn btn-primary btn-xs" >
                                    补钱
                                </button><?php endif; ?>
