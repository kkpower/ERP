    ...
    <div class="col-md-12">
        <section class="panel">
            <header class="panel-heading">
                ...
                <h2 class="panel-title"><?php echo ($countryname); ?>扩展名称</h2>
            </header>
                ...
                <div>
                    <table id="table1" class="table table-hover mb-none table-striped table-bordered" style="border-collapse: collapse;">
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" onclick="ckedit('<?php echo ($vo["id"]); ?>','<?php echo ($vo["name"]); ?>')"><?php echo (L("Modify")); ?></button>
                                </td>
...
<script>
    ...
    function doupdate(){
        $.ajax({
            url:"<?php echo U('Warehouse/countryNameEdit');?>",
            type:"post",
            data:{
                id:$('#hld').val(),
                rate:$('#rate1').val()
