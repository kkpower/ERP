	...
	<div class="col-md-12">
		<section class="panel">
			...
			<div class="panel-body">
				...
				<form target="_blank" action="<?php echo U('Order/alladdProductAsinSku');?>" method="post" name="file" accpet="text/csv,text/csv" enctype="multipart/form-data">
					...
					<div class="input-group" style="width: 35%;margin: 20px 0;">
						<input id="photoCover" class="form-control"  readonly="readonly">
						<a class="input-group-addon" style="text-decoration: none;cursor: pointer;" onclick="$('#file').click();"><?php echo (L("Document")); ?></a>
					</div>
					<input id="form_submit" disabled="disabled" class="btn btn-primary" type="submit" value="<?php echo (L("Sub")); ?>" />
				</form>
			</div>
		</section>
	</div>
