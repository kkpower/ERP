    ...
    <div class="col-md-12">
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <form class="" action="<?php echo U('PurchaseOrder/orderAll');?>" method="get" style="display: inline-block;float: left;margin-right:15px ;">
                    <div class="input-group" style="width: 500px;float: left;">
						<span class="input-group-addon">
                    		订单号
                	</span>
                        <input name="search" type="text" value="<?php echo ($ordernumber); ?>" class="form-control" placeholder="请输入订单号">
                    </div>
                    <div class="col-md-3">
                ...
                <table id="table1" class="table table-hover mb-none table-striped table-bordered" style="border-collapse: collapse;margin-top: 20px;">
                    ...
                    <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                            <td><?php echo ($k); ?></td>
                            <td><a href="<?php echo U('PurchaseOrder/completedDetails',array('id'=>$vo['id']));?>" target="_blank">PO<?php echo ($vo["order_number"]); ?></a></td>
                            <td><a href="<?php echo U('Supplier/detail',array('id'=>$vo['sup_id']));?>" target="_blank"><?php echo ($vo["name"]); ?></a></td>
                            <td>
                                <?php if(($vo["receiving_status"]) == "1"): ?>已完成<?php endif; ?>
                                <?php if(($vo["receiving_status"]) == "2"): ?>未完成<?php endif; ?>
                                <?php if(($vo["receiving_status"]) == ""): ?>未完成<?php endif; ?>
                            </td>
                            <td>
                                <a href="<?php echo U('PurchaseOrder/orderTracking',array('id'=>$vo['id']));?>" target="_blank" style="border: 0px;color: #fff;" class="btn btn-primary btn-xs">详情</a>
                            </td>
