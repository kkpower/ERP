...
<!-- end: sidebar -->
    ...
    <div class="right-wrapper pull-right">
        ...
        <a class="sidebar-right-toggle" data-open="sidebar-right"><i class="fa fa-chevron-left"></i></a>
            ...
            <!-- start: page -->
            <link rel="stylesheet" type="text/css" href="/InternalSystem/Public/FirstEdition/assets/shu/boot/bootstrap-fileinput.css" />
<script src="/InternalSystem/Public/FirstEdition/assets/shu/boot/bootstrap-fileinput.js"></script>
<div class="row">
	<div class="col-md-12">
		<section class="panel">
			<header class="panel-heading">
				...
				<h2 class="panel-title"><?php echo (L("product_thumbnail_upload")); ?></h2>
			</header>
			<div class="panel-body">
				<form action="<?php echo U('Product/productthmup');?>" enctype="multipart/form-data" method="post">
					<input type="hidden" name="pid" value="<?php echo ($pid); ?>">
					<div class="form-group" id="uploadForm" enctype='multipart/form-data'>
						<div class="h4"><?php echo (L("picture_preview")); ?></div>
						<div class="fileinput fileinput-new" data-provides="fileinput" id="exampleInputUpload">
							<div class="fileinput-new thumbnail" style="width: 200px;height: auto;max-height:150px;">
								<img id='picImg' style="width: 100%;height: auto;max-height: 140px;" src="/InternalSystem/Public/img/noimage.png" alt="" />
							</div>
							<div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;"></div>
							<div>
								<span class="btn btn-primary btn-file">
                            <span class="fileinput-new"><?php echo (L("Document")); ?></span>
								<span class="fileinput-exists"><?php echo (L("changeone")); ?></span>
								<input type="file" name="pic1" id="picID" accept="image/gif,image/jpeg,image/x-png" />
								</span>
								<a href="javascript:;" class="btn btn-warning fileinput-exists" data-dismiss="fileinput" style="color: #fff;"><?php echo (L("remove")); ?></a>
							</div>
						</div>

					</div>
					<button type="submit"  class="btn btn-info"><?php echo (L("Sub")); ?></button>
				</form>
			</div>
		</section>
