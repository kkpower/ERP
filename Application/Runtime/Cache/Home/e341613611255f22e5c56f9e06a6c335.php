...
<!--<?php echo ($vo["uid"]); ?>:<?php echo ($vo["pl_account_id"]); ?>:  ,,,,<?php echo ($vo["lastnamezh"]); ?>,,,,<?php echo ($vo["namezh"]); ?><br/>-->
    ...
    <div class="col-md-12">
        <section class="panel">
            <header class="panel-heading">
                ...
                <h2 class="panel-title"><?php echo (L("Useraccountlist")); ?></h2>
                <span><?php echo (L("User")); echo $_SESSION['user_info']['lastnamezh'].$_SESSION['user_info']['namezh'];?> <span style="color: #CD0000;" ><?php echo ($ptname); ?></span><span><?php echo (L("Availableaccount")); ?></span><span style="color: #CD0000;"><?php echo ($pid); ?></span></span>
            </header>
            <div class="panel-body">
                <div id="node_message" style="position: fixed;top: 50%;left: 50%;display: none;background: #888;min-width:300px;margin-left: -150px;margin-top:-15px;border-radius: 8px;text-align: center;font-size: 16px;padding: 12px 20px;color: #fff;z-index: 1200;"></div>
                <table id="table1" class="table table-hover table-striped table-bordered" style="margin-top: 20px;border-collapse: collapse;">
                    <thead>
                    <tr>
                        <th><?php echo (L("Id")); ?></th>
                        <th><?php echo (L("Account")); ?></th>
                        <th><?php echo (L("Plform")); ?></th>
                ...
                <div class="modal-body" style="line-height: 34px;">
                    <div class="row" style="margin-left: 0;margin-right: 0;">
                        <div class="input-group" style="padding-top: 20px;">
                            <span class="input-group-addon">关联<span style="color: #CD0000;"><?php echo ($ptname); ?></span><span>平台下的外部账号</span><span style="color: #CD0000;"><?php echo ($pid); ?></span></span>
