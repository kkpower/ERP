    ...
    <div class="col-md-12">
        <section class="panel">
            <header class="panel-heading">
                ...
                <h2 class="panel-title">进度详情 : <span style="color: red;">PO<?php echo ($ordernumber); ?></span></h2>
            </header>
            <div class="panel-body">
                ...
                <table id="table1" class="table table-hover mb-none table-striped table-bordered" style="border-collapse: collapse;margin-top: 20px;">
                    ...
                    <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                            <td><?php echo ($k); ?></td>
                            <td>
                                <?php if(($vo["action"]) == "1"): ?>已申请<?php endif; ?>
                                <?php if(($vo["action"]) == "2"): ?>已初审<?php endif; ?>
                                <?php if(($vo["action"]) == "3"): ?>已复审,已发货<?php endif; ?>
                            </td>
                            <td><?php echo ($vo["lastnamezh"]); echo ($vo["namezh"]); ?></td>
                            <td>
                               <?php echo ($vo["creationtime"]); ?>
                            </td>
                    ...
                    <?php if($info != '' ): ?><tr>
                            ...
                            <td><?php echo ($info["lastnamezh"]); echo ($info["namezh"]); ?></td>
                            <td>
                                <?php echo ($info["creationtime"]); ?>
                            </td>
                        </tr><?php endif; ?>
