    ...
    <div class="col-md-12">
        <section class="panel">
            <header class="panel-heading">
                ...
                <h2 class="panel-title"><?php echo (L("Purchaseordernumber")); ?>:<span style="color: #EE0000;font-weight: bold;">PO<?php echo ($purchsearchid); ?></span></h2>
            </header>
            <div class="panel-body">
                ...
                <table id="table" class="table table-hover mb-none table-striped table-bordered" style="border-collapse: collapse;margin-top: 15px;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?php echo ($purchaselist["delivery_date"]); ?></td>
                ...
                <table id="table1" class="table table-hover mb-none table-striped table-bordered" style="border-collapse: collapse;">
                    ...
                    <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                            <td><?php echo ($k); ?></td>
                            <td>PN<?php echo ($vo["id"]); ?></td>
                        <td><?php if(($vo["type"]) == "2"): echo (L("received")); else: echo (L("unreceived")); endif; ?></td>
                            <td><?php echo ($vo["creation_time"]); ?></td>
                            <td>
                                <a href="<?php echo U('PurchaseOrder/caseproductDetails',array('id'=>$vo['id'],'oid'=>$vo['order_purchase_id']));?>" target="_blank" style="border: 0px;color: #fff;" class="btn btn-primary btn-xs">查看</a>
                            </td>
